...
public class ImageUtil {
    ...
    public static void main(String[] args) {
        ...
        // 方法二：按高度和宽度缩放
        ImageUtil.resizeByAbsolute("E:/WillenFoo/Private Secret/Girl Picture/psb1.jpg", "e:/abc_scale2.jpg", 500, 300, true);//测试OK
...
*/    }
     ...
     */
    public final static void resizeByProportion(String srcImageFile, String result,
	...
	public static BufferedImage resizeByRelative(BufferedImage source, int targetw,int targeth) {
     ...
     */
    public final static void resizeByAbsolute(String srcImageFile, String result, int height, int width, boolean bb) {
        try {
