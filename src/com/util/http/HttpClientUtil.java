	...
	*/
	public static String get(String url, Map<String, String> params, String charset) {
		...
		try {
			...
			throw new UtilException("客户端连接协议错误", e);
		} catch (IOException e) {
			throw new UtilException("IO操作异常", e);
		} finally {
	...
	*/
	public static String post(String url, Map<String, String> params, String charset) {
		...
		try {
			...
			throw new UtilException("不支持的编码集", e);
		}
	...
	*/
	public static String post(String url, Map<String, String> params, String charset, final URL keystoreUrl, 
		...
		try {
			...
			throw new UtilException("指定的加密算法不可用", e);
		} catch (KeyStoreException e) {
			throw new UtilException("keytore解析异常", e);
		} catch (CertificateException e) {
			throw new UtilException("信任证书过期或解析异常", e);
		} catch (FileNotFoundException e) {
			throw new UtilException("keystore文件不存在", e);
		} catch (IOException e) {
			throw new UtilException("I/O操作失败或中断 ", e);
		} catch (UnrecoverableKeyException e) {
			throw new UtilException("keystore中的密钥无法恢复异常", e);
		} catch (KeyManagementException e) {
			throw new UtilException("处理密钥管理的操作异常", e);
		} finally {
			abortConnection(hp, httpclient);
		}
		return responseStr;
